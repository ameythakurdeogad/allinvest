...
const HOW_STEPS = [
  { num: "01", title: "Tell us about yourself", desc: "Answer 9 quick questions — takes under 3 minutes. No jargon, no tricks." },
  { num: "02", title: "Get your personalised plan", desc: "We instantly match you to the most relevant plans from our catalogue based on your actual profile." },
  { num: "03", title: "Book a free expert call", desc: "If you want human guidance, book a free 30-minute call with our certified advisors. No pressure, ever." },
];

const TRUST_ITEMS = [
  { val: "7+", label: "Curated plans" },
...
const FAQS = [
  { q: "Is this actually free?", a: "Yes, completely. We never charge for the assessment or the advisor call. We earn only if you choose to buy a plan through us." },
  { q: "Will someone call me without my permission?", a: "Never. We only contact you if you explicitly book a call. No cold calling, no WhatsApp spam." },
  { q: "Are these plans from only one insurer?", a: "Our current catalogue features Tata AIA plans. We are transparent about this — if a plan from another insurer is better for you, our advisor will tell you so." },
  { q: "Is my personal information safe?", a: "We don't store your assessment data unless you book a call. Your information is never sold or shared with any third party." },
];
    ...
    <div className="min-h-screen mesh-bg">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-20 pb-16">
        <div ref={heroRef}>
          <div className="inline-flex items-center gap-2 bg-gold/10 border border-gold/30 rounded-full px-4 py-1.5 mb-8">
            ...
            <span className="text-sm font-medium text-navy">Unbiased. Free. No sales pressure.</span>
          </div>
          ...
          <p className="text-lg text-slate max-w-xl leading-relaxed mb-10">
            ...
            We instantly show you which plans actually make sense for you —
            not what earns the highest commission.
          </p>
        ...
        <div className="max-w-5xl mx-auto px-6 py-8 grid grid-cols-2 md:grid-cols-4 gap-6">
          {TRUST_ITEMS.map(item => (
            <div key={item.label} className="text-center">
              <div className="font-display text-3xl font-bold text-navy">{item.val}</div>
      ...
      <section id="how" className="max-w-5xl mx-auto px-6 py-20">
        <div className="mb-12">
          ...
          <p className="text-slate mt-2">Three steps. No obligation at any stage.</p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          {HOW_STEPS.map(step => (
            <div key={step.num} className="relative">
              <div className="text-5xl font-display font-bold text-navy/10 mb-4 leading-none">{step.num}</div>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-12">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              <h2 className="font-display text-2xl font-bold mb-2">Ready to find your plan?</h2>
              <p className="text-white/70 text-sm">3 minutes. Completely free. No account needed.</p>
            </div>
            <button
              onClick={onStart}
