...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "endowment",  label: "Endowment / Money Back",  sublabel: "Savings + life cover",                 emoji: "💰" },
      { value: "ulip",       label: "ULIP",                    sublabel: "Market-linked investment + cover",      emoji: "📈" },
      { value: "health",     label: "Health Insurance",        sublabel: "Medical / hospitalisation cover",       emoji: "🏥" },
      { value: "pension",    label: "Pension / Annuity",       sublabel: "Retirement income plan",                emoji: "🏦" },
      { value: "whole-life", label: "Whole Life / Traditional",sublabel: "Lifelong cover with bonuses",           emoji: "📋" },
    ],
  },
  {
    id: "healthConditions",
